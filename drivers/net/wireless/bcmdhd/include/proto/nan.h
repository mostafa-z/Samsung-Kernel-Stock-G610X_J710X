 ...
 *
 * $Id: nan.h 669938 2016-11-11 21:59:23Z $
 */
#ifndef _NAN_H_
#define _NAN_H_
...
#define NAN_FTM_SET_BURST_DUR(ftm, dur) (ftm |= (((dur/16) & NAN_FTM_MAX_BURST_DUR_MASK) <<\
...
typedef BWL_PRE_PACKED_STRUCT struct wifi_nan_sec_ncssk_key_desc_attr_s {
	...
	uint8 mic[NAN_SEC_NCSSK_DESC_MIC_LEN];
	uint16 data_len; /* key data len */
	uint8 data[];	/* key data */
} BWL_POST_PACKED_STRUCT wifi_nan_sec_ncssk_key_desc_attr_t;

/* Key Info fields */
#define NAN_SEC_NCSSK_DESC_MASK	0x3
#define NAN_SEC_NCSSK_DESC_SHIFT	0
#define NAN_SEC_NCSSK_DESC_KEY_TYPE_MASK	0x4
#define NAN_SEC_NCSSK_DESC_KEY_TYPE_SHIFT	2
#define NAN_SEC_NCSSK_DESC_KEY_INSTALL_MASK	0x40
#define NAN_SEC_NCSSK_DESC_KEY_INSTALL_SHIFT	5
#define NAN_SEC_NCSSK_DESC_KEY_ACK_MASK	0x80
#define NAN_SEC_NCSSK_DESC_KEY_ACK_SHIFT	6
#define NAN_SEC_NCSSK_DESC_KEY_MIC_MASK	0x100
#define NAN_SEC_NCSSK_DESC_KEY_MIC_SHIFT	7
#define NAN_SEC_NCSSK_DESC_KEY_SEC_MASK	0x200
#define NAN_SEC_NCSSK_DESC_KEY_SEC_SHIFT	8
#define NAN_SEC_NCSSK_DESC_KEY_ERR_MASK	0x400
#define NAN_SEC_NCSSK_DESC_KEY_ERR_SHIFT	9
#define NAN_SEC_NCSSK_DESC_KEY_REQ_MASK	0x800
#define NAN_SEC_NCSSK_DESC_KEY_REQ_SHIFT	10
#define NAN_SEC_NCSSK_DESC_KEY_ENC_KEY_MASK	0x1000
#define NAN_SEC_NCSSK_DESC_KEY_ENC_KEY_SHIFT	11
#define NAN_SEC_NCSSK_DESC_KEY_SMK_MSG_MASK	0x2000
#define NAN_SEC_NCSSK_DESC_KEY_SMK_MSG_SHIFT	12
...
#define NAN_SEC_NCSSK_KEY_DESC_VER		3	/* NIST AES Key warp with AES-128 CMAC */
