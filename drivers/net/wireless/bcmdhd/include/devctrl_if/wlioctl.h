 ...
 *
 * $Id: wlioctl.h 669898 2016-11-11 15:35:50Z $
 */
...
typedef enum wl_nan_tlv {
	...
	WL_NAN_XTLV_CFG_SEC_CSID	= NAN_CMD(WL_NAN_CMD_CFG_COMP_ID, 0x07), /* Security CSID */
	WL_NAN_XTLV_CFG_SEC_PMK         = NAN_CMD(WL_NAN_CMD_CFG_COMP_ID, 0x08), /* Security PMK */
...
#define WL_INTERFACE_CREATE_VER		WL_INTERFACE_CREATE_VER_2
...
#ifndef WL_IFACE_CREATE_WLIOCTL_DEF
typedef wl_interface_create_v2_t wl_interface_create_t;
typedef wl_interface_info_v1_t wl_interface_info_t;
#endif /* WL_IFACE_CREATE_WLIOCTL_DEF */
...
/* TLV definitions and data structures  for rsdb subcmd */
...
typedef struct wl_adps_rssi {
	int32 high_thres;		/* rssi threshold to resume ADPS operation */
	int32 low_thres;		/* rssi threshold to pause ADPS operation */
} wl_adps_rssi_t;
